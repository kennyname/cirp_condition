...
#### 15 包燈（ ）用電登記單
  ...
  - 變動別為00的情況下
    ...
    - 轉帳單位必為數字
***
<span style="color:white" id="16"></span>
#### 16 包燈（ ）用電登記單
...
#### 17 包制用電整批更正計算日連絡單
  ...
  - 最高用戶電號需>=最低用戶電號
***
<span style="color:white" id="18"></span>
#### 18 高壓（ ）登記單
  - 契約、用電別有填，行業別必填
  - 用電種類7、8  收費帳戶需為 B、C
  - 變動別00、01、02、03、04、21 限制用戶類別1-8
  ...
  - 變動別限制縣市別輸入
    - 變動別為[00,01,02,03,04,21], 限制縣市別為[01,02,03,04,05,11,13,14,15,16,17,18,19,21,22,23,24,31,32,33,34,35,36,37,41,42,43,51,52,53,61,62])
***
<span style="color:white" id="19"></span>
#### 19 需量　終止契約／復電 登記單
  - 電表形式限制相別輸入，以下為錯
    - 電表型式有值，但不是兩個字元
    - 電表型式有值，倍數為空或缺填
  ...
  - 電表型別之檢定年月不可超過未來，也不可小於目前年月
***
<span style="color:white" id="20"></span>
#### 20 高壓需量用電資料更正連絡單
  - 收費帳戶 限制收費區輸入規則
    - 收費帳戶為D -> 收費戶區00A~00Z
    - 收費帳戶為E -> 收費戶區[123489][0-9][0-9]
  ...
  - 除去上述狀況，935欄位開頭必為B、D、E、F、G、H
    ...
    - 開頭為G(限電回饋型)
      ...
      - G 000000直接過
***
<span style="color:white" id="21"></span>
#### 21 高壓需量用電計收遲付費用連絡單
***
<span style="color:white" id="22"></span>
#### 22 限制用電資料聯絡單（一 ）
  - E卡只能Cycle 14
...
***
<span style="color:white" id="23"></span>
#### 23 停電資料連絡單
  - C卡計算日不能25、變動別54,55
  - F卡計算日只能25、變動別54,55
  ...
  - 用戶電號有填，以下必填
    ...
    - 變動別
***
<span style="color:white" id="24"></span>
#### 24 需量用電整批資料更正聯絡單
  - 輸入日，最高用戶電號和最低用戶電號不可重複輸入
  - 收費帳戶 限制收費區輸入規則
    - 收費帳戶為D -> 收費戶區00A~00Z
  ...
  - 最高用戶電號需>=最低用戶電號
***
<span style="color:white" id="26"></span>
#### 26 特殊用電聯絡單
  - F卡，特殊用電不可輸入E、F、I、J
  - C卡計算日不能25
  - E卡計算日只能14
  - F卡計算日只能25
***
<span style="color:white" id="27"></span>
#### 27 用戶基本資料更正連絡單
  - 馬祖計算日限制11-16
  - C卡計算日不能25、行業別僅能低壓
  - E卡計算日只能14、行業別僅能高壓
...
***
<span style="color:white" id="35"></span>
#### 35 臨時用電保證戶數聯絡單
  - E卡必須14計算日
***
<span style="color:white" id="36"></span>
#### 36 中央空調用電登記單
***
<span style="color:white" id="37"></span>
#### 37 臨時用電登記單（附頁）
***
<span style="color:white" id="38"></span>
#### 38 公共設施電費分攤登記單